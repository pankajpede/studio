          ...
          <>
            ...
            <div className="grid gap-2">
             ...
             <div className="grid gap-2">
              ...
              <Input id="election-id" placeholder="Enter Election ID number" />
            </div>
             <div className="grid gap-2">
    ...
    <div className="flex flex-col gap-6 p-4 md:p-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Select a role for the new user and fill in their details. The form will change based on your selection.
          </CardDescription>
        </CardHeader>
        <CardContent>
